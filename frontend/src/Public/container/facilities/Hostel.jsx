  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${HostelImg})` }}
      >
        <div className="bg-black bg-opacity-30 text-gray-200 py-2 absolute  bottom-5 px-2 md:px-4 w-80 md:w-[30rem] ">
          ...
          >
            &ldquo;They cannot stop me. I will get my education if it is in the
            home, school, or any place.&rdquo;
          </blockquote>
