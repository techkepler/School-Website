...
const ScienceLab = () => {
  ...
  useEffect(() => {
    setCurrentLocation("Science Lab");
  }, [setCurrentLocation]);
  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${ScienceLabImg})` }}
      >
        <div className="bg-black bg-opacity-30 text-gray-200 py-2 absolute  bottom-5 px-2 md:px-4 w-80 md:w-[30rem] ">
          ...
          >
            &ldquo;Take the attitude of a student, never be too big to ask
            questions, never know too much to learn something new.&rdquo;
          </blockquote>
