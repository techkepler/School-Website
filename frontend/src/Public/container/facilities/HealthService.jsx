...
const Health = () => {
  ...
  useEffect(() => {
    setCurrentLocation("Health Service");
  }, [setCurrentLocation]);
  ...
  return (
    <div className="w-full relative">
      ...
      <div
        ...
        style={{ backgroundImage: `url(${HealthServiceImg})` }}
      >
        <div className="bg-black bg-opacity-30 text-gray-200 py-2 absolute  bottom-5 px-2 md:px-4 w-80 md:w-[30rem] ">
          ...
          >
            &ldquo;It is as impossible to withhold education from the receptive
            mind as it is impossible to force it upon the unreasoning.&rdquo;
          </blockquote>
          <small className="text-base md:text-lg mt-3 block">
            &mdash; Agnes Repplierg
          </small>
        </div>
      </div>
      <div>
