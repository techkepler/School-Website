...
import { staffSideBar } from "../../Data/NavBarList";
...
const StaffSideNav = () => {
  ...
  return (
    ...
    >
      <p className="flex absolute right-4 top-3 items-center justify-center h-12 w-12 bg-slate-200 group  dark:bg-slate-300 rounded-full">
        <FaAngleDoubleLeft
          className=" text-3xl  cursor-pointer transition-transform group-hover:-translate-x-2"
