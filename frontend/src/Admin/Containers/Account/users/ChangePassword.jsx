...
const ChangePassword = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      let res = await axiosAdmin.post("users/password/reset/", formData);
    ...
    <div className="my-5 flex justify-center items-center">
      ...
      >
        <div className="flex flex-col w-full items-center justify-center ">
          <form className="my-10 dark:bg-slate-900  w-full md:w-[30rem] pt-5 pb-14 px-4 rounded-lg md:px-8  lg:px-12  border border-slate-500">
            ...
            <div className="mt-10">
              <button
                ...
                disabled={!validUserId || !validPassword || !validConfirmPass}
              >
                Submit
              </button>
            </div>
