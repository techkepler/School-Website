...
const EditNews = () => {
  ...
  useEffect(() => {
    const fetchInfo = async () => {
      let res = await axiosAdmin.get(`informations/crud/news/${slugs}`);
        ...
        <div className="my-10 flex justify-center items-center">
            ...
            <form className="w-full my-4 pb-5 md:px-6 flex flex-col items-center justify-center ">
              <div className="w-full flex flex-col gap-8  justify-center my-4 ">
                ...
                <div className="w-full">
                  ...
                  >
                    <span className="text-red-500 mr-1">*</span>
                    <span style={{ color: themeColor }}>Write news:</span>
                  </label>
                  <Editor
                ...
                <div className=" w-full">
                  ...
                  >
                    <span className="text-red-500 mr-1">*</span>
                    <span style={{ color: themeColor }}>News Slug</span>
                  </label>
                  <input
                    type="text"
                    id="slug"
                ...
                <div className=" w-full">
                  ...
                  >
                    <span className="text-red-500 mr-1">*</span>
                    <span style={{ color: themeColor }}>News Category</span>
                  </label>
                  <select
                    type="text"
                    id="category"
                    ...
                    required
                    className="form-input rounded-md dark:bg-slate-800 dark:text-slate-300 py-3 lg:py-5 px-3  w-full"
                  >
                    <option value="">--Select One--</option>
                    <option value="Academic News">Academic News</option>
                    <option value="Admission News">Admission News</option>
                    <option value="Athletic News">Athletic News</option>
                ...
                <div className="w-full">
                  ...
                  >
                    <span className="text-red-500 mr-1">*</span>
                    <span style={{ color: themeColor }}>News Image</span>
                  </label>
                ...
                <div className="w-full">
                  ...
                  >
                    ...
                    <span style={{ color: themeColor }}>
                      Do you want to make this news public or not ?
                    </span>
                  </label>
                ...
                <div className=" flex gap-4 justify-center items-center w-full">
                  <button
                    ...
                    onClick={log}
                    disabled={
                      !title || !shortDetails || !slug || !category || !status
                    }
                  >
                    Submit
                  </button>
          ...
          >
            <div className="w-80 md:w-96 h-36 bg-slate-300  px-4 py-4 rounded-md flex flex-col justify-between">
              <p className="">Are you sure you want to update this news?</p>
