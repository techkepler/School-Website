...
const AddBlogs = ({ isViewInfoClick }) => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      let res = await axiosAdmin.post("informations/crud/blogs/", formData);
    ...
    <div className="my-10 flex justify-center items-center">
      ...
      >
        <div className="w-80 md:w-96 h-36 bg-slate-300  px-4 py-4 rounded-md flex flex-col justify-between">
          <p className="">Are you sure you want to submit this articles?</p>
