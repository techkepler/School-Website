...
const AddParent = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      let res = await axiosAdmin.post("parents/crud/parent/", formData);
  ...
  const handleSubmitBtn = async (e) => {
    ...
    try {
      let res = await axiosAdmin.post("parents/register/excel/file/", formData);
      setSucsMsg(res.status);
              ...
              <form className="w-full my-4 pb-5 md:px-6">
                <div className="w-full flex flex-wrap gap-6  justify-center my-4">
                  <div className=" w-full md:w-[48%]">
                    ...
                    <button
                      className="px-2 py-1 rounded-sm my-1 bg-sky-400"
