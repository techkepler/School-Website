...
const SearchTeacherAttendance = () => {
  ...
  const handleSubmitBtn = async (e) => {
    ...
    let res = await axiosAdmin.get(
      `teachers/crud/attendance/?id=${id}&name=${name}`
    );
              ...
              {responseData.length > 0 &&
                responseData.map((datas, index) => (
                  ...
                  >
                    ...
                    <td className="whitespace-nowrap  p-5 text-sm text-center">
                      <Link to={`/admin/teachers/attendance/edit/${datas.id}/`}>
...
export default SearchTeacherAttendance;
