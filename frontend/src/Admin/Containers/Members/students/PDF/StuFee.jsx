...
import stuFeePdf from "../../../../Docs/stu/StuFee";
...
const StuFeePdf = () => {
  ...
  const handleSubmitBtn = async (e) => {
    e.preventDefault();
    let res = await axiosAdmin.get(`students/crud/fees/public/?grade=${grade}`);
    setData(res.data);
  ...
  const stuHeaders = [
    ...
    { label: "Computer Fee", key: "computer_fee" },
    { label: "Bus Fee", key: "bus_fee" },
    { label: "Paid Fee", key: "paid_fee" },
    { label: "Unpaid Fee", key: "unpaid_fee" },
