...
const ViewResult = () => {
  ...
  const [searchStu, setSearchStu] = useState(true);
          ...
          {filterData()?.length > 0 && (
            <div className="overflow-auto my-10 bg-slate-100 rounded-md dark:bg-slate-900  box-border shadow-2xl">
              <table className="w-full">
                <thead>
                  <tr className="  text-slate-700 dark:text-[#05dcf8] bg-gray-300 dark:bg-slate-700 border-b-[1px] border-slate-300 dark:border-slate-800 pb-4">
