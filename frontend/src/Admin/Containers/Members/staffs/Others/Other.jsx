...
const TeacherOther = () => {
  ...
  const resetSalaryClick = async (e) => {
    ...
    try {
      await axiosAdmin.post("staffs/salary/reset/", {
        date: currentDate,
      });
      setSucsMsg("Staff Salary Reset Successfully.");
  ...
  const resetAttendanceClick = async (e) => {
    ...
    try {
      await axiosAdmin.post("staffs/attendance/reset/", {
        date: currentDate,
      });
      setSucsMsg("Staff Attendance Reset Successfully.");
      ...
      >
        ...
        >
          <div className="w-80 md:w-96 h-36 bg-slate-300  px-4 py-4 rounded-md flex flex-col justify-between text-slate-700">
            <p className="">
              Are you sure you want to reset staff salary ? This process is
              irreversible.
            </p>
        ...
        >
          <div className="w-80 md:w-96 h-36 bg-slate-300  px-4 py-4 rounded-md flex flex-col justify-between text-slate-700">
            <p className="">
              Are you sure you want to reset staff attendance? This process is
              irreversible.
            </p>
