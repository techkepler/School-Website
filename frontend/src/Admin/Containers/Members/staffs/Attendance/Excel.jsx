...
const ExcelForm = () => {
  ...
  const handleSubmitBtn = async (e) => {
    ...
    try {
      let res = await axiosAdmin.post(
        "staffs/attendance/excel/register/",
        formData
      );
  ...
  return (
    <>
      ...
      {errMsg && (
        <div className="items-center w-full absolute  flex md:justify-center">
          <p className="px-4 w-[90%]  md:w-[60%] top-0  py-2  text-slate-900 bg-red-500  rounded-md fixed text-center z-40 text-sm md:text-base">
