...
const UpdateAttendance = () => {
  ...
  const handleSubmitBtn = async (e) => {
    ...
    e.preventDefault();
    try {
      let res = await axiosAdmin.post("staffs/attendance/update/", {
        date: currDate,
      });
    ...
    <>
      ...
      {sucsMsg === 201 && (
        <div className="items-center w-full absolute  flex md:justify-center">
          <p className="px-4 text-sm md:text-base w-[90%]  md:w-[60%] top-0  py-2 text-slate-900 bg-green-500 rounded-md fixed text-center z-40">
