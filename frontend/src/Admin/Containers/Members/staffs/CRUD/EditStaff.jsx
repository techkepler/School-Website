...
const EditStaff = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let res = await axiosAdmin.get(`staffs/crud/staff/${id}/`);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      let res = await axiosAdmin.put(`staffs/crud/staff/${id}/`, formData);
  ...
  return (
    <>
      ...
      >
        ...
        {errMsg.msg && (
          <div className="items-center w-full absolute  flex   md:justify-center ">
            <p className="px-4 text-sm  md:text-base md:w-[60%] capitalize py-2 top-0  text-gray-900 bg-red-500  rounded-md fixed text-center z-40">
            ...
            <form className="w-full my-4 pb-5 md:px-6">
              ...
              <div className="w-full flex flex-wrap gap-6 items-center justify-center my-4">
                <div className="w-full md:w-[48%]">
                  ...
                  >
                    <span className="text-red-500 mr-1">*</span>
                    <span style={{ color: themeColor }}>Position</span>
                  </label>
                  <select
                    name="position"
                    id="position"
